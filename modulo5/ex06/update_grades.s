...
.section .text
    ...
    .global update_grades	#void update_address(Student *s, int *new_grades)
...
body:
	movl $10, %ecx #Inicia o contador a 10 (tamanho do array grades)
	
	#Mover a string/char array/pointer para %eax
	leal GRADES_OFF(%esi, 1), %eax
	
loop:
	
	# Mover o int do array para %ebx
	movl (%edi), %ebx
